...
void gdevice2::TN3_FullCab_dgemm(int npack, int ne, double alpha, double *a, double *b,
                         double beta, double *caa, double *cab, double *cbb) {
   mygdevice2->TN3_FullCab_dgemm(npack, ne, alpha, a, b, beta, caa, cab, cbb);
}
...
void gdevice2::TN_dgemm2c(int n, int m, int npack2, int nida2, double *a,
                          double *b, double *c) {
...
void gdevice2::NN_dgemm1(int n, int m, int k, double alpha, double *a, int lda,
                         double *b, int ldb, double beta, double *c, int ldc) {
  mygdevice2->NN_dgemm1(n, m, k, alpha, a, lda, b, ldb, beta, c, ldc);
}
void gdevice2::TN_dgemm2(int n, int m, int k, double alpha, double *a, int lda,
                         double *b, int ldb, double beta, double *c, int ldc) {
  mygdevice2->TN_dgemm2(n, m, k, alpha, a, lda, b, ldb, beta, c, ldc);
}
void gdevice2::NT_dgemm3(int n, int m, int k, double alpha, double *a, int lda,
                         double *b, int ldb, double beta, double *c, int ldc) {
...
void gdevice2::NN_eigensolver0(int n, double *a, double *w) {
   mygdevice2->NN_eigensolver0(n, a, w);
}
...
void gdevice2::NC2_zgemm(int npack1_max, int npack, int ne, int nprj,
                         double *alpha, double *a, double *b, double *beta,
                         double *c) {
#if defined(NWPW_SYCL) || defined(NWPW_CUDA) || defined(NWPW_HIP)
  if (mygdevice2->hasgpu)
    mygdevice2->NC2_stride_zgemm(npack1_max, npack, ne, nprj, alpha, a, b, beta,
                                 c);
  else
#endif
...
void gdevice2::NN_zgemm(int n, int m, int k, double *alpha, double *a, int lda,
                        double *b, int ldb, double *beta, double *c, int ldc) {
  mygdevice2->NN_zgemm(n, m, k, alpha, a, lda, b, ldb, beta, c, ldc);
}

void gdevice2::NC_zgemm(int n, int m, int k, double *alpha, double *a, int lda,
                        double *b, int ldb, double *beta, double *c, int ldc) {
  mygdevice2->NC_zgemm(n, m, k, alpha, a, lda, b, ldb, beta, c, ldc);
}

void gdevice2::CN_zgemm(int n, int m, int k, double *alpha, double *a, int lda,
                        double *b, int ldb, double *beta, double *c, int ldc) {
  mygdevice2->CN_zgemm(n, m, k, alpha, a, lda, b, ldb, beta, c, ldc);
}

void gdevice2::CN4_zgemm(int npack1_max, int npack, int ne, double *alpha,
                         double *a, double *b, double *beta, double *caa,
                         double *cab, double *cba, double *cbb) {
  mygdevice2->CN4_zgemm(npack1_max, npack, ne, alpha, a, b, beta, caa, cab, cba,
                        cbb);
}

void gdevice2::CN3_zgemm(int npack1_max, int npack, int ne, double *alpha,
                         double *a, double *b, double *beta, double *caa,
                         double *cab, double *cbb) {
  mygdevice2->CN3_zgemm(npack1_max, npack, ne, alpha, a, b, beta, caa, cab,
                        cbb);
}

/*
void gdevice2::computeTrans3_Mult(const int ne, const int nprj,
                                  const double *psi, const double *prj, int ng,
int ng0, double *Gx, double *Gy, double *Gz, double *xtmp1, double *sum3) { if
(!mygdevice2->hasgpu)
...
/*
void gdevice2::computeTrans_Mult(int ne, int nprj, double alpha, double alpha1,
int ng, int ng0, double *psi, double *prj, double beta, double beta1, double
*sum1)
{
   if (!mygdevice2->hasgpu)
...
int gdevice2::batch_fft_init(int nx, int ny, int nz, int nq1, int nq2,
                             int nq3) {
  int tag = -1;
#if defined(NWPW_CUDA) || defined(NWPW_HIP) || defined(NWPW_SYCL)
  if (mygdevice2->hasgpu)
...
void gdevice2::batch_fft_pipeline_mem_init(const int nstages,
                                           const int n2ft3d) {
#if defined(NWPW_CUDA) || defined(NWPW_HIP) || defined(NWPW_SYCL)
  if (mygdevice2->hasgpu)
...
void gdevice2::batch_rfftx_tmpx(const int tag, bool forward, int nx, int nq,
                                int n2ft3d, double *a, double *tmpx) {
#if defined(NWPW_CUDA) || defined(NWPW_HIP) || defined(NWPW_SYCL)
  if (mygdevice2->hasgpu)
...
void gdevice2::batch_rfftx_stages_tmpx(const int stage, const int tag,
                                       bool forward, int nx, int nq, int n2ft3d,
...
void gdevice2::batch_cfftx_tmpx(const int tag, bool forward, int nx, int nq,
                                int n2ft3d, double *a, double *tmpx) {
#if defined(NWPW_CUDA) || defined(NWPW_HIP) || defined(NWPW_SYCL)
  if (mygdevice2->hasgpu)
...
void gdevice2::batch_cfftx_stages_tmpx(const int stage, const int tag,
                                       bool forward, int nx, int nq, int n2ft3d,
                                       double *a, double *tmpx, int da) {
#if defined(NWPW_CUDA) || defined(NWPW_HIP) || defined(NWPW_SYCL)
  if (mygdevice2->hasgpu)
...
void gdevice2::batch_cffty_tmpy(const int tag, bool forward, int ny, int nq,
                                int n2ft3d, double *a, double *tmpy) {
#if defined(NWPW_CUDA) || defined(NWPW_HIP) || defined(NWPW_SYCL)
  if (mygdevice2->hasgpu)
...
void gdevice2::batch_cffty_tmpy_zero(const int tag, bool forward, int ny,
                                     int nq, int nffts, int n2ft3d, double *a,
                                     double *tmpy, bool *zero) {
#if defined(NWPW_CUDA) || defined(NWPW_HIP) || defined(NWPW_SYCL)
  if (mygdevice2->hasgpu)
    mygdevice2->batch_cffty(tag, forward, ny, nq, n2ft3d, a);
#endif
...
void gdevice2::batch_cffty_stages_tmpy(const int stage, const int tag,
                                       bool forward, int ny, int nq, int n2ft3d,
                                       double *a, double *tmpy, int da) {
#if defined(NWPW_CUDA) || defined(NWPW_HIP) || defined(NWPW_SYCL)
  if (mygdevice2->hasgpu)
    mygdevice2->batch_cffty_stages(stage, tag, forward, ny, nq, 1, n2ft3d, a,
                                   da);
#endif
}

void gdevice2::batch_cffty_stages_tmpy_zero(const int stage, const int tag,
                                            bool forward, int ny, int nq,
                                            int nffts, int n2ft3d, double *a,
                                            double *tmpy, bool *zero, int da) {
#if defined(NWPW_CUDA) || defined(NWPW_HIP) || defined(NWPW_SYCL)
  if (mygdevice2->hasgpu)
    mygdevice2->batch_cffty_stages(stage, tag, forward, ny, nq, nffts, n2ft3d,
                                   a, da);
#endif
}

void gdevice2::batch_cfftz_tmpz(const int tag, bool forward, int nz, int nq,
                                int n2ft3d, double *a, double *tmpz) {
#if defined(NWPW_CUDA) || defined(NWPW_HIP) || defined(NWPW_SYCL)
  if (mygdevice2->hasgpu)
...
void gdevice2::batch_cfftz_tmpz_zero(const int tag, bool forward, int nz,
                                     int nq, int nffts, int n2ft3d, double *a,
                                     double *tmpz, bool *zero) {
#if defined(NWPW_CUDA) || defined(NWPW_HIP) || defined(NWPW_SYCL)
  if (mygdevice2->hasgpu)
    mygdevice2->batch_cfftz(tag, forward, nz, nq, n2ft3d, a);
#endif
...
void gdevice2::batch_cfftz_stages_tmpz(const int stage, const int tag,
                                       bool forward, int nz, int nq, int n2ft3d,
                                       double *a, double *tmpz, const int da) {
#if defined(NWPW_CUDA) || defined(NWPW_HIP) || defined(NWPW_SYCL)
  if (mygdevice2->hasgpu)
    mygdevice2->batch_cfftz_stages(stage, tag, forward, nz, nq, 1, n2ft3d, a,
                                   da);
#endif
}

void gdevice2::batch_cfftz_stages_tmpz_zero(const int stage, const int tag,
                                            bool forward, int nz, int nq,
                                            int nffts, int n2ft3d, double *a,
                                            double *tmpz, bool *zero, int da) {
#if defined(NWPW_CUDA) || defined(NWPW_HIP) || defined(NWPW_SYCL)
  if (mygdevice2->hasgpu)
    mygdevice2->batch_cfftz_stages(stage, tag, forward, nz, nq, nffts, n2ft3d,
                                   a, da);
#endif
}
...
void gdevice2::batch_cfft(const int tag, const bool forward, const int nz,
                          const int nq, const int nffts, const int n2ft3d,
                          double *a, const double *twiddle, const double *tmpz,
                          const int xyz_gpu) {
#if defined(NWPW_CUDA) || defined(NWPW_HIP) || defined(NWPW_SYCL)
  if (mygdevice2->hasgpu) {
    if (xyz_gpu == 0)
      mygdevice2->batch_cfftx(tag, forward, nz, nq, n2ft3d, a);
    if (xyz_gpu == 1)
      mygdevice2->batch_cffty(tag, forward, nz, nq, n2ft3d, a);
    if (xyz_gpu == 2)
      mygdevice2->batch_cfftz(tag, forward, nz, nq, n2ft3d, a);
  }
#endif
...
void gdevice2::batch_cfft_zero(const int tag, const bool forward, const int nz,
                               const int nq, const int nffts, const int n2ft3d,
                               double *a, const double *twiddle,
                               const double *tmpz, const bool *zero,
                               const int xyz_gpu) {
#if defined(NWPW_CUDA) || defined(NWPW_HIP) || defined(NWPW_SYCL)
  if (mygdevice2->hasgpu) {
    if (xyz_gpu == 0)
